...
bot_token = '5558635892:AAEpI0iqMFqB-LRQ8BKzJEALoIdMZhOzJUA'  # Replace with your bot token
...
ADMIN_ID = 1461755686  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @bgmiprince: {ADMIN_ID}")
